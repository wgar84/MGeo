...
### 1. Você acha que faz sentido que o efeito de co-ocorrência seja
### testado de forma independente do efeito de espécie?

### 2. Qual as principais diferenças entre a ANOVA de Procrustes e a
### MANOVA sobre os PCs?
